...
-   character -- specifically a string Lab 4 Question 2: Data Cleaning
...
-   factor Lab 3 Question 13: "Male" and "ethnic1" were Factors
...
-   date Practice Activity 5.1 (Lubridate) Question 2
...
-   factor Lab 3 Question 5 (revision)
...
-   `inner_join()` Preview Activity 4.3.1

```{r wd-5-inner}
inner_join(prof_info, prof_course)
```

-   `full_join()` Preview Activity 4.3.2
...
-   `semi_join()` Lab 4 Data Cleaning (2)
...
-   `anti_join()` Lab 4 Data Cleaning (2)
...
-   Example 1 Lab 5 Question 3.3 (revision)
...
-   Example 1 Lab 3 Question 5 (revision)
...
-   numeric variables and categorical variables Lab 4 Question 6
...
-   dates Lab 5 Question 3.3 (revision)
...
-   Example 1 Lab 4 Question 6 (Revision)
...
-   using a single function call PA3 Part 2
...
-   `across()` Lab 3 Question 5 (revision)
...
-   Example 2 Lab 3 Question 5 (revision)
...
<!-- Include an image of feedback you gave that you are proud of (either in a peer review or in Discord) -->![](images/Screen%20Shot%202023-02-16%20at%2010.59.54%20AM.png){width="360"}
